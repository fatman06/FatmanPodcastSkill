...
def build_card(title, content, ctype='Simple',image=''):
	...
	return {'card': {'type':ctype, 'title': title, 'content': content}}
...
def handle_session_end_request():
    ...
    response = alexa_build_response({}, build_speechlet_response(
...
def on_intent(intent_request, session):
    ...
    if intent_name == "AMAZON.HelpIntent":
        return get_welcome_response()
    elif intent_name == "AMAZON.CancelIntent" or intent_name == "AMAZON.StopIntent" or intent_name == "AMAZON.PauseIntent" or intent_name == "AMAZON.ResumeIntent":
